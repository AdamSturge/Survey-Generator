...
<body>
		...
		<div id="monitor" class="screenElements">
			...
			<div id="createNewSurveyPanel">
				...
				<input style="visibility:hidden;" type="radio"  name="surveyType" value="CustomSurvey" checked="checked"></input><br>
					<p>You are about to create a new Survey, our survey wizard will guide you through the survey setup process. First, what is the <b>name</b> of your survey?</p>
					<br />
					<br />
